...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/papaparse/papaparse.min.js":[function(require,module,exports) {
var define;
/* @license
Papa Parse
v5.3.0
...
},{"moment":"node_modules/moment/moment.js"}],"data/ZonAnn.Ts+dSST.csv":[function(require,module,exports) {
module.exports = "/ZonAnn.Ts+dSST.2b71855d.csv";
},{}],"js/chart-render.js":[function(require,module,exports) {
"use strict";
...
var _ZonAnnTsDSST = _interopRequireDefault(require("../data/ZonAnn.Ts+dSST.csv"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var ctx = document.querySelector('.js-chart').getContext('2d');
var GLOBAL_MEAN_TEMPERATURE = 14; // const webUrl = 'https://cors-anywhere.herokuapp.com/data.giss.nasa.gov/gistemp/tabledata_v4/ZonAnn.Ts+dSST.csv';

fetchData().then(parsedData).then(getLabelandData).then(function (_ref) {
  var years = _ref.years,
      globalTemps = _ref.globalTemps,
      northTemps = _ref.northTemps,
      southTemps = _ref.southTemps;
  return drawChart(years, globalTemps, northTemps, southTemps);
}).catch(function (error) {
  return console.log(error);
});

function fetchData() {
  return fetch(_ZonAnnTsDSST.default).then(function (response) {
...
},{"papaparse":"node_modules/papaparse/papaparse.min.js","chart.js":"node_modules/chart.js/dist/Chart.js","../data/ZonAnn.Ts+dSST.csv":"data/ZonAnn.Ts+dSST.csv"}],"index.js":[function(require,module,exports) {
"use strict";

require("modern-normalize/modern-normalize.css");

require("./js/chart-render.js");
},{"modern-normalize/modern-normalize.css":"node_modules/modern-normalize/modern-normalize.css","./js/chart-render.js":"js/chart-render.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/global-warming-graph.e31bb0bc.js.map